---
title: "STS 2300 Activity 02 - An Introduction to RMarkdown"
author: "SOLUTIONS"
...
3. Let's take a look at adding code to our document. Notice how the section below this question has a gray background. This is an R **code chunk**. We can type code in this section and R will run it sequentially as it knits our document. Write code for one of the numeric summaries from Notes 02 in this section. In the text section below the code, write what is displayed when you knit the document.
...
10. It can be hard to memorize everything we can do with .RMD files. There are a collection of [RStudio cheatsheets at this link](https://rstudio.github.io/cheatsheets/). These can be really useful documents. For example, the RMarkdown one helped me remember how to add a link to my document! Go to this link, find the RMarkdown cheatsheet, and pick a few of the features in the "Write With Markdown" section on the right of the page to experiment with below. Re-knit your document after to see if they worked!

Below are some of the many people may have tried out:
