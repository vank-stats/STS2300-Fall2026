---
title: "STS 2300 Activity 07 - Multiple Linear Regression Practice"
...
For this activity, we'll use the `mario_kart_auction` dataset from the `modenrndive` R package. The data frame includes information from 143 eBay auctions for the Nintendo Wii game Mario Kart. Our goal is to predict the total price at the end of the auction (`total_pr`). (Note: To prevent issues with `moderndive` changing how windows open for some people, I've stored the data as `mariokart` without loading the entire package.)
...
```{r}
mariokart <- moderndive::mario_kart_auction
